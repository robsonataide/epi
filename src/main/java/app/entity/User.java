...
public class User implements Serializable {
   ...
   */
  @ManyToOne
  @JoinColumn(name="empresa", referencedColumnName = "id", insertable=true, updatable=true)
  ...
  private java.lang.Boolean ativo = false;
  
  /**
   * @generated
   */
  @Column(name = "codigoAtivacao", nullable = true, unique = false, insertable=true, updatable=true)
  private java.lang.String codigoAtivacao;
  ...
  /**
   * Obtém codigoAtivacao
   * @param codigoAtivacao codigoAtivacao
   * return codigoAtivacao
   * @generated
   */
  public java.lang.String getCodigoAtivacao(){
    return this.codigoAtivacao;
  }
  
  /**
   * Define codigoAtivacao
   * @param codigoAtivacao codigoAtivacao
   * @generated
   */
  public User setCodigoAtivacao(java.lang.String codigoAtivacao){
