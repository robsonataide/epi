...
public class UserBusiness {
	...
	public User post(final User entity) throws Exception {
		...
		entity.setCodigoAtivacao(UUID.randomUUID().toString().toUpperCase());
	 ...
	 * @modified 
	 */
	public boolean activate(java.lang.String code) {
		try {
			User userToActivate = repository.findByCodeActivation(code);
			userToActivate.setAtivo(true);
			repository.saveAndFlush(userToActivate);
			return true;
		} catch (Exception ex) {
			return false;
		}
